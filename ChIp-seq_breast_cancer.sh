...
echo "ChIP BAM: bam/H3K27ac_sorted.bam"
echo "Control BAM: bam/Input_sorted.bam."
echo "ChIP BigWig: bam/H3k27ac.bw"
echo "Control BigWig: bam/input.bw"
echo "Peak file: peaks/H3K27a_vs_input_peaks.broadPeak"
echo ""
echo "To open IGV:"
...
echo "bam/H3k27ac.bw"
echo "bam/input.bw"
echo "peaks/H3K27a_vs_input_peaks.broadPeak"
